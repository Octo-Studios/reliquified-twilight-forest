                ...
                .abilities(AbilitiesTemplate.builder()
                        .ability(AbilityTemplate.builder("wool_storage")
                                .stat(AbilityStatTemplate.builder("max_slots")
                                        .initialValue(3, 6).targetValue(RelicsScalingModels.ADDITIVE.get(), 1)
                                ...
                                .stat(AbilityStatTemplate.builder("duration")
                                        .initialValue(200, 280).targetValue(RelicsScalingModels.ADDITIVE.get(), 30)
                        ...
                        .ability(AbilityTemplate.builder("effect_stacking")
                                .stat(AbilityStatTemplate.builder("max_amplifier")
                                        .initialValue(2, 4).targetValue(RelicsScalingModels.ADDITIVE.get(), 1)
                                        .formatValue(Math::round)
                                        .build())
                                .requiredPoints(2)
                                .requiredLevel(5)
