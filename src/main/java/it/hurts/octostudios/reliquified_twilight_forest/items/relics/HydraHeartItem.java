...
//                                        .targetValue(RelicsScalingModels.ADD, 1)
//                                        .build())
//                                .maxLevel(5)
//                                .build())
                        .ability(AbilityTemplate.builder("hydra_fire")
                                .stat(AbilityStatTemplate.builder("chance")
                                        ...
                                        .formatValue(MathButCool::percentage).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.12)
                                        .build())
                                .stat(AbilityStatTemplate.builder("damage")
                                        .initialValue(1, 2)
                                        .formatValue(MathButCool::roundSingleDigit).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.8)
                                        .build())
                                .stat(AbilityStatTemplate.builder("lifetime")
                                        .initialValue(80, 100)
                                        .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit).targetValue(RelicsScalingModels.ADDITIVE.get(), 20)
                                        .build())
