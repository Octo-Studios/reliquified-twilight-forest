...
public class LichCrownAbilities {
    public static final Map<String, AbilityTemplate> ABILITIES = new HashMap<>();
    ...
    public static final AbilityTemplate FORTIFICATION = register(AbilityTemplate.builder("fortification")
            .stat(AbilityStatTemplate.builder("max_shields")
                    .initialValue(3, 5).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 1)
    ...
    public static final AbilityTemplate ZOMBIE = register(AbilityTemplate.builder("zombie")
            .stat(AbilityStatTemplate.builder("max_zombies")
                    .initialValue(1, 2).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 1)
                    .formatValue(Math::round)
                    .build())
            .stat(AbilityStatTemplate.builder("damage")
                    .initialValue(2, 3).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.5)
                    .formatValue(MathButCool::roundSingleDigit)
                    .build())
            .stat(AbilityStatTemplate.builder("interval")
                    .initialValue(400, 320)
                    .upgradeModifier(RelicsScalingModels.EXPONENTIAL.get(), -0.075f)
                    .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit)
                    .build())
            .build(), RTItems.NECROMANCY_GEM);

    public static final AbilityTemplate TWILIGHT = register(AbilityTemplate.builder("twilight")
            .stat(AbilityStatTemplate.builder("damage")
                    .initialValue(3, 4).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.5)
                    .formatValue(MathButCool::roundSingleDigit)
                    .build())
            .stat(AbilityStatTemplate.builder("speed_scale")
                    .initialValue(0.9, 1.2).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.1)
                    .formatValue(MathButCool::roundSingleDigit)
                    .build())
            .build(), RTItems.TWILIGHT_GEM);

    public static final AbilityTemplate LIFEDRAIN = register(AbilityTemplate.builder("lifedrain")
            .stat(AbilityStatTemplate.builder("heal_percentage")
                    .initialValue(0.0075, 0.015).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.0035)
                    .formatValue(value -> MathButCool.roundSingleDigit(value * 400))
                    .build())
            .stat(AbilityStatTemplate.builder("radius")
                    .initialValue(2, 5).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.5)
                    .formatValue(MathButCool::roundSingleDigit)
                    .build())
            .stat(AbilityStatTemplate.builder("interval")
                    .initialValue(300, 260)
                    .upgradeModifier(RelicsScalingModels.EXPONENTIAL.get(), -0.1f)
                    .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit)
                    .build())
            .build(), RTItems.ABSORPTION_GEM);

    public static final AbilityTemplate FROSTBITE = register(AbilityTemplate.builder("frostbite")
            .stat(AbilityStatTemplate.builder("duration")
                    .initialValue(80, 100).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 10)
                    .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit)
                    .build())
            .build(), RTItems.FROST_GEM);

    public static final AbilityTemplate BIOME_BURN = register(AbilityTemplate.builder("biome_burn")
            .stat(AbilityStatTemplate.builder("multiplier")
                    ...
                    .build())
            .build(), RTItems.FIRE_GEM);

    public static final AbilityTemplate VENDETTA = register(AbilityTemplate.builder("vendetta")
            .stat(AbilityStatTemplate.builder("lifetime")
                    .initialValue(6, 10).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 30 / 18d)
                    .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit)
                    .build())
            .stat(AbilityStatTemplate.builder("multiplier")
                    .initialValue(0.25, 0.5).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 1.5 / 18d)
                    .formatValue(MathButCool::percentage)
                    .build())
            .build(), RTItems.VENGEFUL_GEM);

    public static final AbilityTemplate ETHEREAL_GUARD = register(AbilityTemplate.builder("ethereal_guard")
            .stat(AbilityStatTemplate.builder("max_projectiles")
                    .initialValue(3, 6).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 28 / 18d)
                    .formatValue(Math::round)
                    .build())
            .stat(AbilityStatTemplate.builder("cooldown")
                    .initialValue(300, 200).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), -100 / 18d)
                    .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit)
                    .build())
            .build(), RTItems.ETHER_GEM);

    public static final AbilityTemplate MIRROR_LEECH = register(AbilityTemplate.builder("mirror_leech")
            .stat(AbilityStatTemplate.builder("chance")
                    .initialValue(0.05, 0.1).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.4 / 18d)
                    .formatValue(MathButCool::percentageAndRoundSingleDigit)
                    .build())
            .build(), RTItems.CARMINITE_GEM);

    public static final AbilityTemplate FRENZY = register(AbilityTemplate.builder("frenzy")
            .stat(AbilityStatTemplate.builder("additive_multiplier")
                    .initialValue(0.025, 0.05).upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.3 / 18d)
                    .formatValue(MathButCool::percentageAndRoundSingleDigit)
                    .build())
    ...
    public static void zombieUnequip(SlotContext slotContext, ItemStack stack) {
        ArrayList<UUID> uuids = Lists.newArrayList(stack.getOrDefault(RTDataComponent.LICH_CROWN_ZOMBIES, List.of()));
        uuids.forEach(uuid -> {
            Entity entity = ((ServerLevel) slotContext.entity().level()).getEntity(uuid);
            if (entity != null) entity.discard();
        });
        uuids.clear();
        stack.set(RTDataComponent.LICH_CROWN_ZOMBIES, List.of());
    }
    ...
    public static void fortificationTick(LivingEntity entity, ItemStack stack) {
        ...
        stack.set(RTDataComponent.LICH_CROWN_FORTIFICATION_TIME, time);
    }
    ...
    public static void lifedrainTick(LivingEntity entity, ItemStack stack) {
        ...
        stack.set(RTDataComponent.LICH_CROWN_LIFEDRAIN_TIME, time);
    }
    ...
    public static void twilightTick(LivingEntity entity, ItemStack stack) {
        ...
        int time = stack.getOrDefault(RTDataComponent.LICH_CROWN_TWILIGHT_TIME, 0);
        if (time > 0) {
            time--;
        }
        stack.set(RTDataComponent.LICH_CROWN_TWILIGHT_TIME, time);
    }
    ...
    public static void zombieTick(LivingEntity entity, ItemStack stack) {
        ...
        int time = stack.getOrDefault(RTDataComponent.LICH_CROWN_ZOMBIE_TIME, 0);
        ArrayList<UUID> uuids = Lists.newArrayList(stack.getOrDefault(RTDataComponent.LICH_CROWN_ZOMBIES, List.of()));
        ...
        if (time > 0) time--;
        stack.set(RTDataComponent.LICH_CROWN_ZOMBIE_TIME, time);
        ...
        stack.set(RTDataComponent.LICH_CROWN_ZOMBIES, uuids);
    }

    public static void frenzyTick(LivingEntity entity, ItemStack stack, LichCrownItem instance) {
        List<UUID> entities = stack.getOrDefault(RTDataComponent.LICH_CROWN_ENTITIES, List.of());
        ServerLevel serverLevel = (ServerLevel) entity.level();
        if (entities.isEmpty() && stack.getOrDefault(RTDataComponent.LICH_CROWN_MULTIPLIER, 0).floatValue() == 0f) {
            return;
        }
...
//        });
        ...
        int time = stack.getOrDefault(RTDataComponent.LICH_CROWN_TIME, 0);

        if (time >= 100) {
            resetFrenzy(entity, stack, null);
        }

        stack.set(RTDataComponent.LICH_CROWN_TIME, ++time);
    }
...
//        }
        ...
        stack.set(RTDataComponent.LICH_CROWN_ENTITIES, uuids);
        stack.set(RTDataComponent.LICH_CROWN_MULTIPLIER, 0f);
        stack.set(RTDataComponent.LICH_CROWN_TIME, 0);
    }
    ...
    public static class CommonEvents {
        ...
        public static void frenzyDeath(LivingDeathEvent e) {
            ItemStack stack = EntityUtils.findEquippedCurio(e.getSource().getEntity(), RTItems.LICH_CROWN.get());
            ...
            stack.set(RTDataComponent.LICH_CROWN_ENTITIES, List.of());
            stack.set(RTDataComponent.LICH_CROWN_TIME, 0);
        ...
        public static void processFrenzy(LivingDamageEvent.Pre e) {
            ...
            float multiplier = stack.getOrDefault(RTDataComponent.LICH_CROWN_MULTIPLIER, 0f);
            e.setNewDamage(e.getNewDamage() * (multiplier + 1));
            multiplier += (float) relic.getStatValue(stack, "frenzy", "additive_multiplier");

            stack.set(RTDataComponent.LICH_CROWN_ENTITIES, mutable);
            stack.set(RTDataComponent.LICH_CROWN_MULTIPLIER, multiplier);
            stack.set(RTDataComponent.LICH_CROWN_TIME, 0);
        }

        @SubscribeEvent
        public static void processMirrorLeech(LivingDamageEvent.Pre e) {
            ItemStack stack = EntityUtils.findEquippedCurio(e.getEntity(), RTItems.LICH_CROWN.get());
        ...
        public static void storeRevengeData(LivingDamageEvent.Post e) {
            ...
            ItemStack stack = EntityUtils.findEquippedCurio(victim, RTItems.LICH_CROWN.get());
    ...
    private static AbilityTemplate register(AbilityTemplate data, DeferredHolder<Item, GemItem> gem) {
