                ...
                .abilities(AbilitiesTemplate.builder()
                        .ability(AbilityTemplate.builder("iron_guard")
                                .stat(AbilityStatTemplate.builder("flat_armor")
                                        .initialValue(0.2, 0.4).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.16)
                                        .formatValue(MathButCool::roundSingleDigit)
                                        .build())
                                .stat(AbilityStatTemplate.builder("chance")
                                        .initialValue(0.1, 0.25).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.025)
                                        .formatValue(MathButCool::percentage)
                                        .build())
                                .stat(AbilityStatTemplate.builder("damage")
                                        .initialValue(4, 6).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.6)
                                        .formatValue(MathButCool::roundSingleDigit)
                                        .build())
                                .stat(AbilityStatTemplate.builder("stun_duration")
                                        .initialValue(10, 20).targetValue(RelicsScalingModels.ADDITIVE.get(), 8)
