                ...
                .abilities(AbilitiesTemplate.builder()
                        ...
                        .ability(AbilityTemplate.builder("poking")
                                .stat(AbilityStatTemplate.builder("paralyze_chance")
                                        ...
                                        .formatValue(MathButCool::percentage).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.02)
                                        .build())
                                .stat(AbilityStatTemplate.builder("paralyze_duration")
                                        .initialValue(10, 20)
                                        .formatValue(MathButCool::ticksToSecondsAndRoundSingleDigit).targetValue(RelicsScalingModels.ADDITIVE.get(), 10)
                                        .build())
                                .stat(AbilityStatTemplate.builder("damage")
                                        .initialValue(1, 2)
                                        .formatValue(MathButCool::roundSingleDigit).targetValue(RelicsScalingModels.ADDITIVE.get(), 0.5)
                                        .build())
