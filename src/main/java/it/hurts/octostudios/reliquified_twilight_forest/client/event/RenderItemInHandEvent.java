...
public class RenderItemInHandEvent extends Event {
    ...
    public ItemRenderer getItemRenderer() { return renderer; }
    public LivingEntity getEntity() { return entity; }
    public ItemStack getItemStack() { return itemStack; }
    public ItemDisplayContext getDisplayContext() { return displayContext; }
    public boolean isLeftHand() { return leftHand; }
    ...
    public void setDisplayContext(ItemDisplayContext displayContext) { this.displayContext = displayContext; }
    public void setLeftHand(boolean leftHand) { this.leftHand = leftHand; }
    public void setPoseStack(PoseStack poseStack) { this.poseStack = poseStack; }
    public void setMultiBufferSource(MultiBufferSource multiBufferSource) { this.multiBufferSource = multiBufferSource; }
    public void setPackedLight(int packedLight) { this.packedLight = packedLight; }
    public void setPackedOverlay(int packedOverlay) { this.packedOverlay = packedOverlay; }
}
