...
public class ItemRegistry {
    ...
    public static final DeferredHolder<Item, Item> TWILIGHT_GEM   = ITEMS.register("twilight_gem",   () -> new GemItem());
    public static final DeferredHolder<Item, Item> ABSORPTION_GEM = ITEMS.register("absorption_gem", () -> new GemItem());
    public static final DeferredHolder<Item, Item> NECROMANCY_GEM = ITEMS.register("necromancy_gem", () -> new GemItem());
    public static final DeferredHolder<Item, Item> SHIELDING_GEM  = ITEMS.register("shielding_gem",  () -> new GemItem());
